...
3. **AggregateAction:**
   ...
   **Purpose:** It reduces bandwidth and increases efficiency. For example, instead of sending 60 separate temperature readings every second, it aggregates them into a single average reading sent once per minute.
